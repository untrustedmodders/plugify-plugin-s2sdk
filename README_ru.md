...
- Интерактивные меню (WASD-кнопочное, чат, консоль и center-HTML)
...
- Создание интерактивных **меню** — WASD-кнопочное, чат, консоль и center-HTML — для игроков  
  → [Руководство: Меню](https://plugify.net/plugins/s2sdk/guides/menus)
